...
Current HealthCore UIs:

- **`talent-pipeline-tracker`** — authenticated Internal Workspace (login, profile, incident manager host routes)
- **`incidents`** — Centralized Incident Manager registration, list, and summary interface
- **`web`** — previous CSV incident analyzer (unchanged)
