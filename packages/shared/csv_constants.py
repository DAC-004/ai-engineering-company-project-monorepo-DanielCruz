"""HealthCore incident-analyzer CSV contract.

Extracted from the previous incident-analyzer project so the seed script and
the analyzer share one copy of clinic IDs, categories, and invalid-rule keys.
"""
